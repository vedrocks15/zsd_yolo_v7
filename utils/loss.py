...
sys.path.append('/home/AD/vejoshi/yolo_open_world/zsd_yolo_v7/models/yolo')
...
class ZSDCrossEntropy(nn.Module):
    ...
    def __init__(self, hyp, det):
        ...
        # no clue what is the purpose of this....
